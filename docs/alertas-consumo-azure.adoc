...
IMPORTANT: En el curso 2023 esta opción *no estuvo* disponible para las cuentas Azure para estudiantes. En el 2024 parece que *de nuevo está disponible!!!*. Desde 2025 en adelante esta opción ya no está disponible, por tanto se recomienda configurar el https://ualjjcanada.github.io/azure-tips/docs/auto-encendido-apagado-vm.html[autoencendido y autoapagado de las máquinas virtuales] para evitar gastos innecesarios.
