...
IMPORTANT: No olivides *elminar la IP estática*. Aunque esté desasociada sigue existiendo y formando parte del grupo de recursos. Desde el grupo de recursos, elige la IP estática desasociada y eliminalá. 
