...
https://learn.microsoft.com/es-es/azure/azure-resource-manager/management/move-resource-group-and-subscription?tabs=azure-cli#use-the-azure-portal[Traslado de los recursos a una nueva suscripción]
