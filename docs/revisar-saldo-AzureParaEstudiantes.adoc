...
== Revisar el saldo (_new_)

Haz clic en _Education_. 

.Azure Education
image::costs/azure-education.png[role="thumb", align="center", width=60%]

Verás el saldo restante de tu suscripción Azure for Students, así como la fecha de expiración del crédito.

.Azure Education: overview
image::costs/azure-education-overview.png[role="thumb", align="center", width=60%]
