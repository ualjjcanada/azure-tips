...
. link:https://learn.microsoft.com/es-es/azure/virtual-machines/linux/quick-create-portal?tabs=ubuntu[Documentación oficial: Creación de una máquina virtual Linux en Azure Portal]

. link:https://learn.microsoft.com/es-es/azure/virtual-machines/windows/quick-create-portal[Documentación oficial: Creación de una máquina virtual de Windows en Azure Portal]

. link:docs/alertas-consumo-azure.html[Añadir alertas de consumo (budgets) en Azure] (🚫 _deprecated_ 🚫)

. link:docs/autoapagado-vm.html[Autoapagado de VM en Azure]

. link:docs/auto-encendido-apagado-vm.html[Autoencendido y autoapagado de VM en Azure] (⭐ _recomendado_ ⭐) 
...
. link:docs/asignar-ip-dinamica.html[Modificar la IP de estática a dinámica en una VM] ( 🚫_deprecated_ 🚫)

. link:docs/azure-cli.html[Usar Azure CLI para interactuar desde el terminal] 


. link:docs/azure-ahorro-maximo.html[Ahorro en Azure] (⭐ _recomendado_ ⭐)


. link:docs/azure-gestion-ips-publicas.html[Gestión temporal de IPs públicas en Azure] (_Avanzado_)

. link:docs/azure-troubleshoot.html[Azure troubleshooting: Errores habituales y soluciones]

// crea una tabla sin borde de 1 fila y dos columnas para añadir los logos de Azure y GitHub

[cols="<50%,>50%",frame="none",grid="none"]
|===
|
image:https://upload.wikimedia.org/wikipedia/commons/f/fa/Microsoft_Azure.svg[width=10%]
|
